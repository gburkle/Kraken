...
def main():
	...
	parser.add_argument('-path','--path',required=True,help='Directory path where to start looking. Use quotes (e.g. "C:\Program Files\folder")',dest='path')
	parser.add_argument('-F','--folder',required=False,help='Folder name to search and destroy',dest='folder')
	parser.add_argument('-f','--file',required=False,help='File name to search and destroy',dest='file')
	parser.add_argument('-LF','--listfolders',required=False,help='Text file with a list of folders to search and destroy',dest='list_of_folders')
	parser.add_argument('-lf','--listfiles',required=False,help='Text file with a list of files to search and destriy',dest='list_of_files')
